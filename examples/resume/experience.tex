...
\cventry
    ...
    {Amazon Web Services Korea LLC.} % Organization
    {Seoul, S.Korea} % Location
    {July. 2024 - } % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Provided technical support to customers, specializing in AWS networking services.}
        \item {Provide advanced technical support for escalations as a subject matter expert for Elastic Load Balancing and CloudWatch.}
        \item {Create and deliver technical workshops as part of the Containers Technical Field Community.}
      \end{cvitems}
    }
